...
export const CreditOptionSection = () => {
    ...
    return <section id={'credit-option-section'} className={'w-full h-full max-w-[440px] mx-auto mt-8 mb-32'}>
        <div className={'w-full flex flex-col flex-wrap justify-center items-start w-full scale-95 xlPhone:scale-100'}>
            ...
            <Link href={'/signup/paymentpicker'} className={'text-center mt-4 py-4 bg-skin-theme-600 rounded max-w-screen-lg text-skin-theme-font-900 text-2xl mb-32 tablet:mb-0 w-full'}>{language.b1}</Link>
        </div>
    </section>
}
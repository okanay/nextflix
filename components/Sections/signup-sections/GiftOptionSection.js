...
export const GiftOptionSection = () => {
    ...
    return<m.section variants={animationStore.pageContainer} initial={'initial'} animate={pageAnimation} id={'gift-option-section'} className={'w-full h-full max-w-[440px] mx-auto my-16'}>
        <div className={'w-full flex flex-col flex-wrap justify-center items-start w-full scale-95 xlPhone:scale-100'}>
            ...
            <CurrentPlanBox/>
            <button onClick={handleClick} className={'text-center mt-3 py-4 bg-skin-theme-600 rounded max-w-screen-lg text-skin-theme-font-900 text-2xl tablet:mb-0 w-full'}>{language.b1}</button>

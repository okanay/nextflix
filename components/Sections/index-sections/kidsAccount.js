...
export const KidsAccount =  ({language}) => {
    ...
    return (<section id={'kids-account'}  className={'bg-skin-theme-body-1000 py-11 xlPhone:py-24'}>
        <div className={'flex flex-row flex-wrap-reverse justify-center items-center gap-9 xlPhone:gap-16'}>

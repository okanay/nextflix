...
export const EmailChecklist = () => {
    ...
    return (<section id={'email-checklist'} className={'h-[610px]'}>
        <div
            className={'absolute w-full bg-gradient-to-b from-skin-theme-body-1000 via-skin-theme-body-50/10 to-skin-theme-body-1000 h-[610px] flex flex-col justify-center items-center text-skin-theme-font-900'}>

...
export const RegformSection = () => {
    ...
    return <section id={'registration-section'} className={'w-full flex flex-col justify-start items-center my-8'}>
        <div className={'max-w-screen-xlPhone flex flex-col flex-wrap justify-center items-start w-full scale-95 xlPhone:scale-100'}>
            <h4 className={'text-sm'}>{language.p.p1} <b>1</b> {language.p.p2} <b>3</b></h4>
            ...
            <button className={'mt-6 py-4 bg-skin-theme-600 rounded max-w-screen-lg w-full text-skin-theme-font-900 text-2xl mb-32 tablet:mb-0'}>{language.b1}</button>
        </div>
    </section>
}
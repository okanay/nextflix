...
export const SignInFooter = () => {
    ...
    return (<footer className={'bg-skin-theme-body-100 text-skin-theme-font-50 text-[0.85rem] basePhone:text-[0.9rem] shadow-sm shadow-skin-theme-body-800 w-full absolute bottom-0 '}>

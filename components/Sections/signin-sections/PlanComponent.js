...
export const PlanComponent = () => {
    ...
    return (<section id={'registration-section'} className={'w-full flex flex-col justify-center items-center max-w-[340px] mx-auto py-[5px] xlPhone:py-[75px] tablet:mb-64'}>

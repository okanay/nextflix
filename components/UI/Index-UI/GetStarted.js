        ...
        <div className={'flex flex-row flex-wrap gap-2 justify-center items-center'}>
            <div className={'relative peer'}>
                <input type="text"
                       ...
                       className={'w-[22rem] h-14 bg-transparent bg-skin-theme-body-1000/10 border border-skin-theme-body-400 rounded px-3 peer placeholder:text-transparent focus:outline-none'}
                       placeholder={"."}/>

export const ArrowRightSVG = () => {
    return (
        <span dir="ltr" className="default-ltr-cache-s15e62 e1boxt2d0"><svg width="24" height="24" viewBox="0 0 24 24"
                                                                            fill="none"
                                                                            xmlns="http://www.w3.org/2000/svg"
                                                                            className="text-skin-font-50 max-w-[24px] max-h-[20px] w-full h-fit"><path

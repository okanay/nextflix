        ...
        <div
            ...
            {languageBtn.state && (
                <div
                    ...
                    className={`absolute ${rotation === "down" ? "top-9" : "-top-0.5 left-[7.9rem]"} w-28 bg-skin-theme-body-1000/20 border border-skin-theme-body-600 rounded-sm flex flex-col items-start justify-start px-4 py-2 gap-1`}>

...
export const LanguageSelect = ({rotation}) => {
    ...
    return (
        <div
            ...
            className={'flex flex-row justify-center gap-1 tablet:gap-2 text-skin-theme-font-900 items-center px-2 py-0.5 tablet:py-1 border border-skin-theme-body-400 rounded-sm relative transition-all duration-300 hover:scale-105'}>
            ...
            {languageBtn.state && (
                <div
                    ...
                    className={`absolute ${rotation === "down" ? "top-7 tablet:top-9" : "-top-[0.18rem] left-[7.05rem] tablet:-top-0.5 tablet:left-[7.9rem]"} w-24 tablet:w-28 bg-skin-theme-body-1000/20 border border-skin-theme-body-600 rounded-sm flex flex-col items-start justify-start px-4 py-2 gap-1`}>
